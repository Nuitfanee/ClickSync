...
[https://xn--i8s54d9wak75j.xyz/](https://nuitfanee.github.io/ClickSync.github.io/)
...
├── protocol_api_chaos.js       # Chaos 协议实现（非标准分层架构，大部分代码使用原驱动代码，较为混乱，如需扩展新设备请参考Rapoo、ATK协议实现）
